...
int main(int argc, char** argv) {
    ...
    /*
     * Since all odd numbers (in most sign representations) have
     * the lowest bit set, you can get the answer in a branchless
     * way by indexing the array with the extracted bit.
     */
    printf("%lld is %s.\n", num, desc[num & 1]);
    return EXIT_SUCCESS;
  scanfail:
